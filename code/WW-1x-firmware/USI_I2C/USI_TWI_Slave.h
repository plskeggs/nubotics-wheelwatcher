...
//! Prototypes
extern void          Flush_TWI_Buffers(void);
extern void          USI_TWI_Slave_Initialise( unsigned char );
extern void          USI_TWI_Slave_Init(void);
extern void          USI_TWI_Transmit_Byte( unsigned char );
extern unsigned char USI_TWI_Receive_Byte( void );
extern unsigned char USI_TWI_Data_In_Receive_Buffer( void );
extern void          Timer_Init(void);
extern void          USI_TWI_OVERFLOW_ISR(void);
...
#else
#define SET_USI_TO_TWI_START_CONDITION_MODE() USI_TWI_Slave_Init()
#endif
